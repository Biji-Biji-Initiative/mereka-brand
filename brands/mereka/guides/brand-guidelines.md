...
- The background logo is intended for large-scale use; avoid small sizes where it can become illegible.
- Always use the provided logo files; do not recreate the mark.
...
Note: The guide shows `#295cad` in both primary and secondary palettes.
...
- Used for approved internal partnerships.
...
- Lower thirds: clean design, names in Open Sans Bold, titles in Lato Regular, background at 80% opacity.
- Ending slates: all videos end with the Mereka logo, animated or still.
- Watermarked logos: upper left at 50% opacity.
